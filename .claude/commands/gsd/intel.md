...
Intel system is disabled. To activate:
  ...
  node /Users/e-261/Tools/playlist-o-matic/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/e-261/Tools/playlist-o-matic/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/e-261/Tools/playlist-o-matic/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/e-261/Tools/playlist-o-matic/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /Users/e-261/Tools/playlist-o-matic/.claude/get-shit-done/bin/gsd-tools.cjs
