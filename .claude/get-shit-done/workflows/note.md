...
- **Global scope**: `/Users/e-261/Tools/playlist-o-matic/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/e-261/Tools/playlist-o-matic/.claude/notes/`)
...
2. Glob `/Users/e-261/Tools/playlist-o-matic/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/e-261/Tools/playlist-o-matic/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/e-261/Tools/playlist-o-matic/.claude/notes/` — works in any directory
