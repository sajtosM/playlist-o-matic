...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/e-261/Tools/playlist-o-matic/.claude
                  → checks /Users/e-261/Tools/playlist-o-matic/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/e-261/Tools/playlist-o-matic/.claude/get-shit-done
                  → writes to /Users/e-261/Tools/playlist-o-matic/.claude/get-shit-done/hooks/
...
@/Users/e-261/Tools/playlist-o-matic/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/e-261/Tools/playlist-o-matic/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/e-261/Tools/playlist-o-matic/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/e-261/Tools/playlist-o-matic/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/e-261/Tools/playlist-o-matic/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
