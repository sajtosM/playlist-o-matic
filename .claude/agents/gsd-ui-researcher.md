...
Use template from `/Users/e-261/Tools/playlist-o-matic/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/e-261/Tools/playlist-o-matic/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/e-261/Tools/playlist-o-matic/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
